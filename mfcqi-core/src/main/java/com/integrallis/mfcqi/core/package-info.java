 ...
 * geometric mean, the {@link com.integrallis.mfcqi.core.ParadigmDetector} contract used to select
 * conditional OO metrics, and the {@link com.integrallis.mfcqi.core.JavaSourceFiles} utility for
 * walking a codebase.
 *
