...
```
Release (dry_run off)
  → JReleaser deploy            → Maven Central (14 library modules + both plugins)
...
|---|---|---|
| 14 library modules (`mfcqi-core`, …, `mfcqi-security-bytecode`, `mfcqi-maven-plugin`) | Maven Central (`com.integrallis`) | `release.yml` (JReleaser) |
